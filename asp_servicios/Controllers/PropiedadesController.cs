...
namespace asp_servicios.Controllers
{
    ...
    {
        private IPropiedadesAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public PropiedadesController(IPropiedadesAplicacion? iAplicacion,
        ...
        public string PorNombre()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Propiedades>(
